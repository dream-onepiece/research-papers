const HowToUseComponent = () => {
    ...
    return <div className="component how-to-use">
        ...
        <p className="heading-third"> What if historical context is unavailable? </p>
        <p className="desc-use"> 
        ...
        <p className="heading-fourth"> Outputs: </p>
        <p className="desc-use">
        ...
        <p className="desc-use"> 
            <span>
                Inputs: The input format is the same but for an additional label column.
            </span>
            <span>
                Outputs: Weighted F1 (along with other metrics)
            </span>
        </p>
        <p className="desc-use">
        ...
        <p className="heading-third">
            How to use HaRT for user-level tasks?
        </p>
        <p className="desc-use">
            <span>
                Inputs: The input format is the same but for an additional label column (replicating the same label for the same user's different input text sequences).
            </span>
            <span>
                Outputs: Pearson r correlation and dis-attenuated pearson r correlation  (along with other metrics)
            </span>
        </p>
        <p className="desc-use">
        ...
        <p className="desc-use">
            For more details, please refer to [Readme] <link to main readme></link>
        </p>
    </div>
